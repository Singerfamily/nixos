...
with lib;
{
  ...
  # options.snowfall.desktop.hyprland = {
  #   enable = mkOption {
  ...
  # config =
  #   let
  #     inherit (config.snowfall.desktop.hyprland)
  #       enable
  #       source
  #       ;
  #   in
  ...
  #       enable = true;
  #       package =
  #         if (source == "nixpkgs") then pkgs.hyprland else inputs.hyprland.packages.${pkgs.system}.default;
